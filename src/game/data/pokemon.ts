...
export const POKEDEX: PokedexEntry[] = [
  ...
  { number: 7,  name: "Cross-Scale MAE",level: 54, types: ["Dragon", "Flying"],     status: "caught", pokemon: "Salamence", description: "Cross-scale masked autoencoder for remote sensing", url: "https://proceedings.neurips.cc/paper_files/paper/2023/hash/3fadcbd0437ef86ca1bba27a18ec7dff-Abstract-Conference.html" },
  { number: 8,  name: "Dementia AI",    level: 60, types: ["Ground", "Rock"],       status: "caught", pokemon: "Camerupt",  description: "Trustworthy feature masking for early dementia", url: "https://scholar.google.com/citations?view_op=view_citation&hl=en&user=b___QQ8AAAAJ&citation_for_view=b___QQ8AAAAJ:Tyk-4Ss8FVUC" },
  { number: 9,  name: "Koopman KTD",    level: 58, types: ["Ghost", "Psychic"],     status: "caught", pokemon: "Banette",   description: "Koopman transition detection in satellite imagery", url: "https://scholar.google.com/citations?view_op=view_citation&hl=en&user=b___QQ8AAAAJ&citation_for_view=b___QQ8AAAAJ:qjMakFHDy7sC" },
  { number: 10, name: "ExPLoRe",        level: 70, types: ["Ice", "Steel"],         status: "caught", pokemon: "Glalie",    description: "Exploration-driven pre-training for remote sensing", url: "https://scholar.google.com/citations?user=b___QQ8AAAAJ" },
