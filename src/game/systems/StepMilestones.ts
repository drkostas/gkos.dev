...
export const STEP_MILESTONES: StepMilestone[] = [
  ...
  { steps: 150,   itemId: "tm_pandas",        tm: "PANDAS",        description: "DataFrames everywhere" },
  { steps: 150,   itemId: "tm_tailwind",      tm: "TAILWIND",      description: "Utility-first CSS" },
  { steps: 150,   itemId: "tm_jupyter",       tm: "JUPYTER",       description: "Research notebooks" },
  { steps: 200,   itemId: "tm_fastapi",       tm: "FASTAPI",       description: "Python web framework" },
  { steps: 250,  itemId: "tm_nextjs",        tm: "NEXT.JS",       description: "React meta-framework" },
  { steps: 300,  itemId: "tm_docker",        tm: "DOCKER",        description: "Containerization" },
  { steps: 500,  itemId: "tm_pytorch",       tm: "PYTORCH",       description: "Deep learning framework" },
  { steps: 1000,  itemId: "tm_huggingface",   tm: "HUGGINGFACE",   description: "Pretrained models hub" },
  { steps: 1500,  itemId: "tm_aws",           tm: "AWS",           description: "Cloud infrastructure" },
  { steps: 2000,  itemId: "tm_kubernetes",    tm: "KUBERNETES",    description: "Container orchestration" },
  { steps: 2500,  itemId: "tm_ray",           tm: "RAY",           description: "Distributed training" },
  { steps: 3000,  itemId: "tm_terraform",     tm: "TERRAFORM",     description: "Infrastructure as code" },
  { steps: 4000,  itemId: "tm_langchain",     tm: "LANGCHAIN",     description: "LLM orchestration" },
  { steps: 5000,  itemId: "tm_system_design", tm: "SYSTEM DESIGN", description: "Architecture at scale" },
  { steps: 6000, itemId: "tm_vercel",        tm: "VERCEL",        description: "Ship it instantly" },
];
