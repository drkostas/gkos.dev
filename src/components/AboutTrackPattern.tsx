    ...
    <div ref={containerRef}>
      ...
      >
        <defs>
          ...
          <mask id="pathMask">
            <path d={PATH_D} stroke="white" strokeWidth="8" strokeLinejoin="round" fill="none" />
          </mask>
          <filter id="trackInnerShadow" x="0" y="0.5" width="380" height="1778" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
